...
- [YouTube](https://www.youtube.com/@DOROFEEVA)
...
- [YouTube](https://www.youtube.com/@KOLAmusic)
...
- [YouTube](https://www.youtube.com/@polyakova)
...
- [YouTube](https://www.youtube.com/@yaktak)
...
- [YouTube](https://www.youtube.com/@kalush)
...
## 📍 Найближчі концерти за містами (дата, ціна, квитки)

Тут лише **підтверджені** дані з офіційної сторінки продажу: дата події, стартова ціна **«від …»** і посилання. Якщо для міста такої зведеної інформації немає — **рядок не додаємо** (перегляньте афіші в розділі нижче).
