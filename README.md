# Українські артисти · дайджест 2026

🎤 **Суть, не шум.** Швидкий огляд: хто «на хвилі», куди їде з концертами і де слухати в один клік.

📊 **Що це:** жива зрізана картина (фестивалі, тури й ротація на радіо змінюються швидко — перевіряйте дати перед покупкою квитків).
...
| Блок | Що всередині |
|------|----------------|
| 🎧 **Артистки** | 11 імен: по **3 фото** (крім **MAMARIKA** — одне прев’ю через Markdown), активність, маршрути, хіт, посилання на стріми |
| 🎧 **Артисти / гурти** | 6 позицій — та сама логіка полів; **Okean Elzy** — одне прев’ю через Markdown |
...
*🖼 Для кожного артиста — **галерея з 3 фото** (HTML `<img>`), окрім **MAMARIKA**: там одне зображення у форматі Markdown (ілюстративне фото з Unsplash). Джерела переважно **Wikimedia Commons** / Вікіпедія (автор і ліцензія — на сторінці файлу). Якщо вільних знімків мало, частина кадрів — різні масштаби одного файлу або аватар YouTube (див. підказки біля імен).*
...
- **Найближчі концерти:** Європа — літо–осінь 2026 (тури / фестивалі)
- **Топ-трек:** *Teresa & Maria*
- **Посилання:**
...
- **Найближчі концерти:** Європа — нерідко разом із Jerry Heil
- **Топ-трек:** *Teresa & Maria*
- **Посилання:**
...
- **Найближчі концерти:** Україна + Європа — регулярні дати (повний календар тут не зафіксовано)
- **Топ-трек:** *Крапають*
- **Посилання:**
  - [Spotify](https://open.spotify.com/search/dorofeeva)
  - [Apple Music](https://music.apple.com/search?term=Dorofeeva)
  - [YouTube](https://www.youtube.com/@DorofeevaOfficial)
...
- **Найближчі концерти:** Україна + Європа
- **Топ-трек:** *Ніжно*
- **Посилання:**
...
- **Найближчі концерти:** Польща / Чехія / маршрути ЄС
- **Топ-трек:** *Я тобі брехала*
- **Посилання:**
  - [Spotify](https://open.spotify.com/search/klavdia%20petrivna)
  - [Apple Music](https://music.apple.com/search?term=Klavdia%20Petrivna)
  - [YouTube](https://www.youtube.com/@klavdiapetrivna)
...
- **Найближчі концерти:** **18 квітня 2026** — Ужгород *(уточніть майданчик і квитки локально)*
- **Топ-трек:** *Бар за баром*
- **Посилання:**
...
- **Найближчі концерти:** Європа — періодичні хвилі турів
- **Топ-трек:** *Біля серця*
- **Посилання:**
...
- **Найближчі концерти:** Осінь **2026** — тур Україною (дати уточнюються)
- **Топ-трек:** *Афини*
- **Посилання:**
...
- **Найближчі концерти:** Формат шоу + концертні дати (дивіться афіші)
- **Топ-трек:** *Королева ночі*
- **Посилання:**
...
- **Найближчі концерти:** Фестивалі / Європа
- **Топ-трек:** *Gravity*
- **Посилання:**
...
- **Найближчі концерти:** фестивалі та клубні виступи (дати з’являються поступово)
- **Топ-трек:** *Люди*
- **Посилання:**
...
## 🎧 Артисти (чоловіки) · гурти

*🖼 Галерея **3 фото**. **SKOFKA** — три розміри офіційного аватара YouTube (Google CDN), бо вільних портретів у Commons майже немає. **Okean Elzy** — одне прев’ю через Markdown (ілюстративне фото з Unsplash).*
...
- **Посилання:**
  ...
  - [YouTube](https://www.youtube.com/@yaktakmusic)
...
- **Найближчі концерти:** Європа + Україна
- **Топ-трек:** *Дежавю*
- **Посилання:**
...
- **Найближчі концерти:** Міжнародні тури
- **Топ-трек:** *Stefania*
- **Посилання:**
...
- **Найближчі концерти:** міжнародні тури (Польща, Чехія, Німеччина); великі майданчики
- **Топ-трек:** *Обійми*
- **Посилання:**
...
## 🔥 Де стежити за концертами

**Світ**

- [**Songkick**](https://www.songkick.com/) — підписка на артистів і сповіщення про шоу поруч.
- [**Eventbrite**](https://www.eventbrite.com/) — афіші по містах; відфільтруйте музичні події.
- [**LiveNation**](https://www.livenation.com/) / [**Ticketmaster**](https://www.ticketmaster.com/) — великі тури й офіційні старти продажу (завжди звіряйте продавця з вашим регіоном).

**Україна**

- [**Concert.ua**](https://concert.ua/) — хаб афіш для концертів в Україні.
- [**Ticketclub**](https://ticketclub.com.ua/) — квитки (UA).

**Для занурених**

- [**Setlist.fm**](https://www.setlist.fm/) — недавні сетлисти, коли хочеться відчути живий сет, а не плейлист.
